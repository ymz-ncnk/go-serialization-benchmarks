...
func (s SerializerNotUnsafeReuse) Marshal(data common.Data) (bs []byte, err error) {
...
func (s SerializerNotUnsafeReuse) Unmarshal(bs []byte) (data common.Data, err error) {
	var n, n1 int
