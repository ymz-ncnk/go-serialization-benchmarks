...
func (s SerializerRawVarintReuse) Marshal(data common.Data) (bs []byte, err error) {
...
func (s SerializerRawVarintReuse) Unmarshal(bs []byte) (data common.Data, err error) {
	var n, n1 int
...
func (s SerializerRawVarintReuse) Name() benchser.ResultName {
	return benchser.NewResultName(MUS, s.features()...)
}

func (s SerializerRawVarintReuse) Features() []benchser.Feature {
